...
const BlogPage: React.FC = () => {
  ...
  return (
    <>
      <SEO
        title="Blog - Freedom Mergers & Acquisitions | Insights & Strategies"
        description="Explore expert articles, guides, and insights to empower your business transition with Freedom Mergers & Acquisitions."
        canonicalUrl="/blog"
      />
